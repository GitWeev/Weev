...
import { ElectricVehicleBlogComponent2 } from './electric-vehicle-blog-2.component';
import { By } from '@angular/platform-browser';

describe('ElectricVehicleBlogComponent', () => {
  let component: ElectricVehicleBlogComponent2;
  let fixture: ComponentFixture<ElectricVehicleBlogComponent2>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ ElectricVehicleBlogComponent2 ]
    })
    .compileComponents();

    fixture = TestBed.createComponent(ElectricVehicleBlogComponent2);
