...
import { ElectricVehicleBlogComponent3 } from './electric-vehicle-blog-3.component';
import { By } from '@angular/platform-browser';

describe('ElectricVehicleBlogComponent', () => {
  let component: ElectricVehicleBlogComponent3;
  let fixture: ComponentFixture<ElectricVehicleBlogComponent3>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ ElectricVehicleBlogComponent3 ]
    })
    .compileComponents();

    fixture = TestBed.createComponent(ElectricVehicleBlogComponent3);
    component = fixture.componentInstance;

    // Add mock data for testing
    component.sectionTitle1 = 'Introduction to Electric Vehicles';
    component.subSection1 = {  content: 'Electric vehicles have a long history.' };
    component.subSection2 = {  content: 'Electric vehicles are gaining popularity.' };
